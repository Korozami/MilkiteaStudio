...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('user_id', sa.Integer(), nullable=False),
    sa.Column('order_number', sa.String(length=400), nullable=False),
    sa.Column('shipping_method', sa.String(length=400), nullable=False),
    sa.Column('tracking_number', sa.String(length=400), nullable=True),
